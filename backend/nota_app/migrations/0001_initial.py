    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('horario_desde', models.CharField(blank=True, max_length=20, null=True)),
                ('horario_hasta', models.CharField(blank=True, max_length=20, null=True)),
                ('id_usuario', models.ForeignKey(db_column='id', on_delete=django.db.models.deletion.DO_NOTHING, related_name='notas_usuario', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'notas',
                'managed': True,
